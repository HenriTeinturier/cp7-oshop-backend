<div class="container my-4">
        ...
        <form action="<?= $router->generate('category-create')  ?>" method="POST" class="mt-5">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="home_order" class="form-control" id="subtitle" placeholder="0 pour ne pas être sur accueil 1 à 5 pour le classement accueil" aria-describedby="subtitleHelpBlock">
                <small id="subtitleHelpBlock" class="form-text text-muted">
